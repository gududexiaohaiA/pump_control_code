# -*- coding: utf-8 -*-
"""
Created on Sun Aug 18 21:26:17 2019
...
# -*- coding: utf-8 -*-
"""
Created on Sun Aug 18 11:32:15 2019
...
class DuelingDQN:
    def __init__(self,n_actions,n_features,learning_rate=0.001,reward_decay=0.9,e_greedy=0.9,replace_target_iter=200,memory_size=500,batch_size=32,e_greedy_increment=None,output_graph=False,dueling=True,sess=None,env=gym.make('Pendulum-v0').unwrapped):
